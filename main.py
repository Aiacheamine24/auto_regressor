...
path = "public/files/imperfect_data_set.csv"

# Split the data into train and test data
result = data_preprocessing(path=path, target=["Salary"], test_size=0.02, random_state=1, 
...
result = simple_linear_regression(X_train, X_test, y_train, y_test)
